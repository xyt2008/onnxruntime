...
TEST(Scan9, TransposeOutputDim2) {
  ...
  test.Run(OpTester::ExpectResult::kExpectSuccess, "", {kTensorrtExecutionProvider, kNupharExecutionProvider});// Disable TensorRT/Nuphar on supported data types
}
...
void MixedTypeInputs(bool is_v8) {
  ...
  test.Run(OpTester::ExpectResult::kExpectSuccess, "", {kTensorrtExecutionProvider, kNupharExecutionProvider});// Disable TensorRT/Nuphar on unsupported data types
}
