...
class NupharFunctionState {
 public:
  ...
  Status Compute(ONNXRunTimeTensor* input_tensors, size_t num_inputs,
                 ONNXRunTimeTensor* output_tensors, size_t num_outputs) const;
 ...
 private:
  ...
  static thread_local std::unique_ptr<
      std::unordered_map<const NupharFunctionState*, std::unique_ptr<tvm_codegen::PackedFuncCallCtx>>>
      tvm_run_state_map_;

  // Hold PackedFunc from codegen.
  std::unique_ptr<tvm_codegen::PackedFuncInfo> pack_info_;
  ...
  mutable tvm_codegen::NupharComputeCtx compute_ctx_;
};
